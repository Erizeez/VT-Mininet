...
#define VIRTUALTIMEUNSHARE 450
#define GETVIRTUALTIMEOFDAY 451
#define SETTIMEDILATIONFACTOR 453

int virtualtimeunshare(unsigned long flags, int dilation)
{
    return syscall(VIRTUALTIMEUNSHARE, flags | 0x03000000, dilation);
}
